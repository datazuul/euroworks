...
public class EuroDock extends JPanel {
    ...
    public static javax.swing.border.Border getDockTileBorder(boolean pressedOrSelected) {
        javax.swing.border.Border outer = BorderFactory.createBevelBorder(
            pressedOrSelected ? BevelBorder.LOWERED : BevelBorder.RAISED,
            Color.WHITE,
            DARK_SHADOW
        );
    ...
    protected void paintComponent(Graphics g) {
        ...
        // 2. Draw 3D-raised bevel on the right edge of the dock body
        ...
        // 3. Draw soft drop shadow gradient on the right (w-3 to w-1)
        g2.setColor(new Color(0, 0, 0, 80)); // 30% black shadow
        g2.drawLine(w - 3, 0, w - 3, h);
        g2.setColor(new Color(0, 0, 0, 40)); // 15% black shadow
        g2.drawLine(w - 2, 0, w - 2, h);
        g2.setColor(new Color(0, 0, 0, 15)); // 5% black shadow
    ...
    private static class ClockTile extends JPanel {
        ...
        private void updateClock() {
            ...
            java.time.format.DateTimeFormatter dateFormatter = java.time.format.DateTimeFormatter.ofPattern("E, d. MMM", java.util.Locale.GERMAN);
